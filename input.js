...
function _0x263eb3(_0x7398c5) {
  if (!_0x7398c5) {
    console.error("Error: _0x7398c5 is undefined or null");
    return ""; // 或者其他适当的默认值
  }
  try {
    const _0x123944 = Buffer.from(_0x7398c5, "utf8");
    const _0x3bab99 = _0x44ed71.publicEncrypt(_0x180f39, _0x123944);
...
function _0x2c9fde(_0xae4788) {
  const carmiKey = process.env.ELE_CARME || process.env.ELE_TTCJ_CARME;
  if (!carmiKey) {
    console.error("Error: Encryption key (ELE_CARME or ELE_TTCJ_CARME) is undefined");
    return "";
  }
  try {
    const _0x35f7ed = _0x44ed71.createDecipheriv("aes-256-cbc", carmiKey, Buffer.from("4lp7ySjYEgwa/LBGW55wMQ==", "base64"));
...
function _0x235b2e(_0x82a409, _0x51972d, _0x4a4231, _0x52a5f9, _0x411ecc, _0x5bd7be, _0x15c240, _0x51d6f6, _0x22e817 = 5) {
  ...
  if (!_0x82a409 || !_0x51972d || !_0x4a4231 || !_0x411ecc || !_0x5bd7be || !_0x15c240 || !_0x51d6f6) {
    console.error("Error: One or more arguments are undefined");
    return "";
  }

  let _0x5c4368 = {
    carmi: process.env.ELE_CARME || process.env.ELE_TTCJ_CARME || 'default_value',
    userId: _0x411ecc,
    gameType: _0x51d6f6,
...
function _0x581038(_0x4bc536, _0x167ae5, _0x4e83b3, _0x47d0b6, _0x47a700, _0x56ac94, _0x2cb8b6, _0x487227) {
  ...
  const _0x3295d8 = {
    ...
    url:"http://elm.bedee.top/getxsign",
